...
from AccumulatedNucleotideFrequency import *
...
def app():
    st.title("Descriptor: Accumulated Nucleotide Frequency (ANF)")
    ...
    if submit:
        try:
            ...
            foutput, max_length = accumulated_nucle_frequency(finput, label_dataset, padd)
