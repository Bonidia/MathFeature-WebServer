...
def app():
    st.title("Descriptor: Fickett score")
    ...
    with st.form(key='form'):
        ...
        seq = st.selectbox('Type of sequence,  DNA or RNA', ['DNA', 'RNA'])
        submit = st.form_submit_button(label='Submit')

    if finput and label_dataset and seq and submit:
        try:
            ...
            if seq == 'DNA':
                ...
                type_seq = 2
            foutput = calculate_sequences(finput, label_dataset, type_seq)
