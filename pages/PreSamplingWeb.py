...
def app():
    st.title("Descriptor: Sampling - Select a number of sequences randomly.")
    ...
    with st.form(key='form'):
        ...
        parameter = st.number_input('Number of Samples, e.g., 1000, 2000', min_value=1, step=1)
    ...
    if submit:
        try:
            ...
            foutput = sampling(finput, parameter)
