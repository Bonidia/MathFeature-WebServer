...
def app():
    st.title("Descriptor: Fourier and Numerical Mapping Approach")
    ...
    if submit:
        try:
            ...
            if tech == 'Binary':
                foutput = binary_fourier(finput, label_dataset)
            elif tech == 'Z-curve':
                foutput = zcurve_fourier(finput, label_dataset)
            elif tech == 'Real':
                foutput = real_fourier(finput, label_dataset)
            elif tech == 'Integer':
                foutput = integer_fourier(finput, label_dataset)
            elif tech == 'EIIP':
                foutput = eiip_fourier(finput, label_dataset)
            elif tech == 'Complex Number':
                foutput = complex_number(finput, label_dataset)
            elif tech == 'Atomic Number':
                foutput = atomic_number(finput, label_dataset)
