...
def file_record(foutput, label_dataset, information_entropy):
    file = open(foutput, 'a')
    ...
    for seq_record in SeqIO.parse(io.StringIO(finput), "fasta"):
        ...
        for k in range(1, ksize+1):
            ...
            if e == "Shannon" or e == "shannon":
                ...
                information_entropy.append(entropy)
        file_record(foutput, label_dataset, information_entropy)
    return foutput
