...
def feature_extraction(metrics):
...
def file_record(foutput, label_dataset, metrics):
...
def complex_network(finput, ksize, label_dataset, threshold):
    ...
    for seq_record in SeqIO.parse(io.StringIO(finput), "fasta"):
        ...
        file_record(foutput, label_dataset, metrics)
